...
type UrlId =
    | GetVersion_PackagesToLower_ToLower
    | GetVersion_PackagesToLowerNormalizedVersion_ToLowerNormalizedVersion
    | GetVersion_PackagesToLower_ToLowerNormalizedVersion
